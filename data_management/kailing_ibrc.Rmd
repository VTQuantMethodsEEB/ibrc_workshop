...
author: "KEL, ATG, MJK - IBRC Workshop"
output:
...
- Some data files: spreadsheets storing data
...
## An example with acoustic data | multiple sites with multiple detectors and thousands of calls recorded
